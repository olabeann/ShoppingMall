...
<h1 class="col-sm-offset-2 col-sm-10">아이디 찾기</h1>
  <form class="form-horizontal">
      ...
      <div class="col-sm-4">
      <input type="text" class="form-control" id="mname" placeholder="Enter mname" name="mname" required="required" >
      </div>
      </div>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-8">
        ...
        <button type="button" class="btn btn-default" onclick="location.href='/member/pwfind'"> 패스워드 찾기</button>
      </div>
    </div>
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-8">
